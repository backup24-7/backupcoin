...
// backupcoin includes.
#include <..\src\script\backupcoinconsensus.h>
...
int main()
{
    std::cout << "backupcoinconsensus version: " << backupcoinconsensus_version() << std::endl;
    ...
    backupcoinconsensus_error err;
    auto op0Result = backupcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, backupcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
