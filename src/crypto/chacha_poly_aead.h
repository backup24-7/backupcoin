...
#ifndef BACKUPCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define BACKUPCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@backupcoin.
 *
 ...
 *
 * The chacha20-poly1305@backupcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@backupcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@backupcoin are relatively fast in
...
#endif // BACKUPCOIN_CRYPTO_CHACHA_POLY_AEAD_H
