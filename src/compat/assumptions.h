...
#ifndef BACKUPCOIN_COMPAT_ASSUMPTIONS_H
#define BACKUPCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "backupcoin cannot be compiled without assertions."
#endif
...
#endif // BACKUPCOIN_COMPAT_ASSUMPTIONS_H
