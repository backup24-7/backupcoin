...
libs = [
    'libbackupcoin_cli',
    'libbackupcoin_common',
    'libbackupcoin_crypto',
    'libbackupcoin_server',
    'libbackupcoin_util',
    'libbackupcoin_wallet_tool',
    'libbackupcoin_wallet',
    'libbackupcoin_zmq',
    'bench_backupcoin',
    'libtest_util',
]
...
def main():
    parser = argparse.ArgumentParser(description='backupcoin-core msbuild configuration initialiser.')
        ...
        with open(vcxproj_filename + '.in', 'r', encoding='utf-8') as vcxproj_in_file:
            with open(vcxproj_filename, 'w', encoding='utf-8') as vcxproj_file:
                vcxproj_file.write(vcxproj_in_file.read().replace(
                    '@SOURCE_FILES@\n', content))
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/backupcoin_config.h'), os.path.join(SOURCE_DIR, 'config/backupcoin-config.h'))
